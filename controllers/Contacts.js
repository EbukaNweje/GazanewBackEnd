                      ...
                      <table width="100%" cellspacing="0" cellpadding="0">
                          <tr>
                              <td style="padding: 10px;">
                                  <div class="contact-info">
                                      ...
                                      <p><img src="https://i.ibb.co/TL7k4FF/Container.png" alt="" style="width: 20px;"> Capitalmining67@gmail.com</p>
                          ...
                          <tr>
                              <td style="padding: 20px 0;">
                                  ...
                                  <h1 style="color: #ffffff; font-size: 40px; font-family: Impact, sans-serif; font-weight: 500">CapitalMining</h1>
                              </td>
                          </tr>
                      </table>
                  </div>
                  ...
                  <div class="footer">
                      <div class="footer-content">
                          ...
                          <div class="footer-info">
                              ...
                              <p>© Copyright 2024 CapitalMining. All Rights Reserved.</p>
                          </div>
                      </div>
                  </div>
              </div>
